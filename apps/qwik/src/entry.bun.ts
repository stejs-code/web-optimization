...
const { router, notFound, staticFile } = createQwikCity({
  ...
  static: {
    ...
    root: join(Bun.fileURLToPath(import.meta.url), "..", "..", "dist"),
  },
});
...
console.log(`Resolved path: ${Bun.fileURLToPath(import.meta.url)}`);
console.log(`Static root should be at: ${join(Bun.fileURLToPath(import.meta.url), "..", "..", "dist")}`);
